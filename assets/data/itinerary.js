 ...
 *   location     Place name/address shown under the activity title
 ...
 *
 * Maps are rendered with Leaflet + OpenStreetMap (see assets/js/app.js) —
 * no API key, no Google sign-in/consent redirects to worry about.
 */
